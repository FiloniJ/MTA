	...
	wm.initMenu = function(t)
		...
		wm.add = exports.dx:dxCreateImage(x*383, y* 543, x*50, y* 50,":task_2/Icons/add.png",wm.menu)
		...
		wm.edit = exports.dx:dxCreateImage(x*433, y* 543, x*50, y* 50,":task_2/Icons/edit.png",wm.menu)
		...
		wm.search = exports.dx:dxCreateImage(x*483, y* 543, x*50, y* 50,":task_2/Icons/search.png",wm.menu)
		...
		wm.delete = exports.dx:dxCreateImage(x*533, y* 543, x*50, y* 50,":task_2/Icons/delete.png",wm.menu)
